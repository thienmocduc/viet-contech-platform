...
console.log(`[DB] OK ${tableCount} tables, ${agentSeedCount} agents seed, ${tcvnSeedCount} TCVN seed | migrations=${migratedCount} | file=${DB_FILE}`);
...
if (isMain) {
    const sample = queryOne('SELECT COUNT(*) AS c FROM projects');
